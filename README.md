...
1.  **Arduino UNO R3**: จัดการการควบคุมฮาร์ดแวร์แบบเรียลไทม์ ซึ่งรวมถึงการอ่านค่าจากแป้นพิมพ์ (Keypad) 4x4, การนับรอบเพลาผ่าน Proximity Sensorด้วยระบบขัดจังหวะ (Pin Change Interrupts), การแสดงผลจำนวนรอบบนจอ TM1637 (7-segment), และการสั่งงานรีเลย์เพื่อควบคุมมอเตอร์
